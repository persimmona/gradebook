            ...
            <table class="data data_zebra">
                ...
                @foreach($wnpDisciplineSems as $wnpDisciplineSem)
                    ...
                    Str::slug( $wnpDisciplineSem->discipline->discipline_name)])}}">{{$wnpDisciplineSem->discipline->discipline_name}}</a></td>
                        ...
                        <td>{{$wnpDisciplineSem->getEmpType1()->employer->last_name}} {{$wnpDisciplineSem->getEmpType1()->employer->short_name}}</td>
                        <td>
                            <ul class = 'data-add__list'>
                                ...
                                <li class = 'data-add__item'>
                                    <div class="data__button data-add__button" data-wnpDisciplineSem = "{{$wnpDisciplineSem->id}}" id="{{$wnpDisciplineSem->getEmpType1()->employer->id}}">
                                    ...
                                    <div class="data__button data-delete__button" data-wnpDisciplineSem = "{{$wnpDisciplineSem->id}}" id="{{$wnpDisciplineSem->getEmpType1()->employer->id}}">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                             width="24" height="24"
                                             viewBox="0 0 172 172"
    ...
    <div class="modal" id="addEditEmpTypeModal">
        <form class="modal-form" id="addEditEmpTypeForm" action="division-editemp" method="post">
            ...
            <div class="modal__head">
                ...
                <h3 class="modal-title">Назначити асистента</h3>
            </div>
            ...
            <div class="modal__body">
                <div class="modal-control">
                    <div class="modal-notification">
                        ...
                        <p class="modal-notification__text">Ви впевнені, що бажаєте видалити асистента?</p>
                    </div>
                </div>
